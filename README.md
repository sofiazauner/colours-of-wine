...
- A running backend for the cloud functions (locally via emulator, or deployed)
...
3. run with according base_URL (see config.dart for more information)


## API Documentation (Endpoints - Cloud Functions)
